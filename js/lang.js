// EN, JP, DE, FR, ES, KO & ZH translation variables for Monos

const LANG_EN = {
    GREETING: "Monos loaded successfully",
    LICENCE: "Monos is made by kirbIndustries, and is licensed under the GNU General Public License, Version 2.0 (GPL-2.0)",
    ...
    SETUP_CANNIBALIZE: "Customize your Monos",
    ...
    SETUP_GURAPPS_USAGE: "Monos Apps Usage",
    SETUP_GURAPPS_USAGE_DESC: "To use Monos Apps, swipe up from the bottom pill and choose an Monos App to launch.",
...
const LANG_JP = {
    ...
    LICENCE: "Monos は kirbIndustries によって作成され、GNU General Public License, Version 2.0 (GPL-2.0) の下でライセンスされています。",
    ...
    SETUP_GURAPPS_USAGE_DESC: "グーラのアプリを使用するには、下のピルから上にスワイプしてMonos Appを選択して起動します。",
...
const LANG_DE = {
    ...
    LICENCE: "Monos wird von kirbIndustries erstellt und ist unter der GNU General Public License, Version 2.0 (GPL-2.0) lizenziert.",
    ...
    SETUP_GURAPPS_USAGE_DESC: "Um Gura-Anwendungen zu verwenden, wischen Sie vom unteren Balken nach oben und wählen Sie eine Monos App zum Starten aus.",
...
const LANG_FR = {
    ...
    LICENCE: "Monos est créé par kirbIndustries, et est sous licence GNU General Public License, Version 2.0 (GPL-2.0)",
    ...
    LOAD_SUCCESS: "Monos chargé avec succès",
    ...
    SETUP_BASIC_ACCESS_DESC: "Permet à Monos de fonctionner correctement",
    ...
    SETUP_GURAPPS_USAGE_DESC: "Pour utiliser Applications Gura, glissez vers le haut depuis la barre du bas et choisissez une Monos App à lancer.",
...
const LANG_ES = {
    GREETING: "Monos cargado con éxito",
    LICENCE: "Monos es creado por kirbIndustries y está licenciado bajo la Licencia Pública General de GNU, Versión 2.0 (GPL-2.0).",
    ...
    SETUP_GURAPPS_USAGE_DESC: "Para usar Aplicaciones Gura, desliza hacia arriba desde la barra inferior y elige una Monos App para iniciar.",
...
const LANG_KO = {
    ...
    LICENCE: "Monos는 kirbIndustries에서 제작되었으며 GNU General Public License, Version 2.0 (GPL-2.0)에 따라 라이선스가 부여됩니다.",
    ...
    SETUP_GURAPPS_USAGE_DESC: "구라앱 사용하려면 하단 막대에서 위로 스와이프하고 시작할 Monos App을 선택하십시오.",
...
const LANG_ZH = {
    GREETING: "Monos加载成功",
    LICENCE: "Monos由kirbIndustries制作，并根据GNU通用公共许可证，版本2.0（GPL-2.0）获得许可",
